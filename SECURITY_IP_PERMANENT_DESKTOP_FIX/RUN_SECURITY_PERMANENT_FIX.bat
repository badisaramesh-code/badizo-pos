...
set "SECURITY_URL=http://%SERVER_HOST%:3000?loginMode=security&loginUser=security"
...
set "ROLE_LAUNCHER_CMD=%ROLE_LAUNCHER_DIR%\Badizo Security.cmd"
set "DESKTOP_SHORTCUT=%USERPROFILE%\Desktop\Badizo.lnk"
set "PUBLIC_DESKTOP_SHORTCUT=%PUBLIC%\Desktop\Badizo.lnk"
set "OLD_DESKTOP_LAUNCHER=%USERPROFILE%\Desktop\Badizo Security.bat"
set "OLD_PUBLIC_DESKTOP_LAUNCHER=%PUBLIC%\Desktop\Badizo Security.bat"
...
title Badizo Security Permanent Fix

echo Badizo Security Permanent Fix
echo Server IP: %SERVER_HOST%
echo Security login: security
echo.
...
if exist "%BADIZO_EXE%" (
  set "BADIZO_APP_URL=%SECURITY_URL%"
...
> "%~1" echo {
>> "%~1" echo   "appUrl": "http://%SERVER_HOST%:3000?loginMode=security^&loginUser=security",
...
>> "%~1" echo set "BADIZO_APP_URL=http://%%SERVER_HOST%%:3000?loginMode=security^&loginUser=security"
