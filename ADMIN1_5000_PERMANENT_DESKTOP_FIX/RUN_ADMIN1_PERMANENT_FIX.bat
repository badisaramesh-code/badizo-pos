...
set "ADMIN1_URL=http://%SERVER_HOST%:5000?loginMode=admin&loginUser=admin1"
...
:write_config
> "%~1" echo {
>> "%~1" echo   "appUrl": "http://%SERVER_HOST%:5000?loginMode=admin^&loginUser=admin1",
...
>> "%~1" echo set "BADIZO_APP_URL=http://%%SERVER_HOST%%:5000?loginMode=admin^&loginUser=admin1"
