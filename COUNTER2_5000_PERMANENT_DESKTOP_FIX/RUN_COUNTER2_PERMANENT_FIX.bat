...
set "COUNTER2_URL=http://%SERVER_HOST%:5000?loginMode=counter&loginUser=counter2"
...
set "DESKTOP_LAUNCHER=%USERPROFILE%\Desktop\Badizo Counter2.bat"
set "PUBLIC_DESKTOP_LAUNCHER=%PUBLIC%\Desktop\Badizo Counter2.bat"
...
title Badizo Counter2 Permanent Fix

echo Badizo Counter2 Permanent Fix
...
:write_config
> "%~1" echo {
>> "%~1" echo   "appUrl": "http://%SERVER_HOST%:5000?loginMode=counter^&loginUser=counter2",
...
>> "%~1" echo set "BADIZO_APP_URL=http://%%SERVER_HOST%%:5000?loginMode=counter^&loginUser=counter2"
