...
set "ROLE_LAUNCHER_CMD=%ROLE_LAUNCHER_DIR%\Badizo Counter2.cmd"
set "DESKTOP_SHORTCUT=%USERPROFILE%\Desktop\Badizo.lnk"
set "PUBLIC_DESKTOP_SHORTCUT=%PUBLIC%\Desktop\Badizo.lnk"
set "OLD_DESKTOP_LAUNCHER=%USERPROFILE%\Desktop\Badizo Counter2.bat"
set "OLD_PUBLIC_DESKTOP_LAUNCHER=%PUBLIC%\Desktop\Badizo Counter2.bat"
...
>> "%~1" echo set "BADIZO_APP_URL=http://%%SERVER_HOST%%:3000?loginMode=counter^&loginUser=counter2"
